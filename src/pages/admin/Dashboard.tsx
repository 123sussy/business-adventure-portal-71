...
const batchesMockData = [
  { id: 1, name: 'Business Bootcamp - Batch 1', students: 25, revenue: 6250, teacherEarning: 1250, ollShare: 1875 },
  { id: 2, name: 'Business Bootcamp - Batch 2', students: 32, revenue: 8000, teacherEarning: 1600, ollShare: 2400 },
  { id: 3, name: 'Advanced Entrepreneurship', students: 18, revenue: 5400, teacherEarning: 1080, ollShare: 1620 },
];
...
const AdminDashboard = () => {
  ...
  const calculateTotalRevenueSplit = () => {
    ...
    const teacherTotal = batchesMockData.reduce((sum, batch) => sum + batch.teacherEarning, 0);
    const ollTotal = batchesMockData.reduce((sum, batch) => sum + batch.ollShare, 0);
